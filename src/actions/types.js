...
export const FETCH_EVENT_FEEDS_START = 'FETCH_EVENT_FEEDS_START'
export const FEEDS_ACTION_START = 'FEEDS_ACTION_START'
export const FEEDS_ACTION_FAILED = 'FEEDS_ACTION_FAILED'
...
export const FETCH_PREVIOUS_MESSAGES_START = 'FETCH_PREVIOUS_MESSAGES_START'
export const FETCH_PREVIOUS_MESSAGES_SUCCESS = 'FETCH_PREVIOUS_MESSAGES_SUCCESS'
